...
$.get("meldunek1.php", { q : 40 },  function(data) {
...
$.get("meldunek1.php", { q : 60 },  function(data) {
...
$.get("meldunek1.php", { q : 80 },  function(data) {
...
$.get("meldunek1.php", { q : 100 },  function(data) {
...
$.get("punkty1.php", { lastfetch : last_update },  function(data) {
$("#punkty").val(data);
		  	...
		  	if(data==1){
				...
				window.location.href="index.php?reset=3";
					...
					//$("#re").show();
						...
						// ostring != 0
						//location.href="index.php?reset=2;
...
if(data==3){
	location.href='sumuj1.php?meldunki='+$('#meldunek1').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s1').val()+'&reset=2&bank='+$('#bank1').val();	
}
if(data==1 || data==2){
$("#koncz").val("ready");
}	
		...
		function koncz(){
			...
			$.get("koncz.php", { q : 1 },  function(data) {
...
<br><br><br>
<img width="50" src="talia.jpg" id="k1" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s1').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k2" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s2').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k3" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s3').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k4" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s4').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k5" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s5').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k6" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s6').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k7" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s7').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k8" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s8').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k9" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s9').val()+'&reset=2';}"> 
<img  width="50" src="talia.jpg" id="k10" onclick="if($('#kolejg').val()=='player1' ){location.href='index.php?meldunki='+$('#meldunki').val()+'&punkty='+$('#punkty').val()+'&kolejg='+$('#kolejg').val()+'&pierwszak='+$('#pierwszak').val()+'&kolejp='+$('#kolejp').val()+'&karta='+$('#s10').val()+'&reset=2';}"> 
...
meldunki:<input type="text" id="meldunek1" value="0"><br>
...
if (!empty($karta)){
	...
	if($pierwszak=="player1"){ echo "<script>checkm('".$karta."');</script>";}
